...
API yang Anda buat harus dapat menampilkan seluruh buku yang tersimpan pada server melalui route:
...
Proyek yang Anda kirim tidak dapat dijalankan dengan baik (Reviewer menggunakan Node.js versi LTS terbaru).
Menggunakan bahasa pemrograman dan teknologi lain, selain JavaScript dan Node.js.
Menggunakan Framework Node.js selain Hapi dan Express Framework.
